    ...
    <head>
        ...
        <script src="./js/divsCommunityEffect.js" defer></script>
        <script src="./js/divsMoveEffect.js" defer></script>
    </head>
    <body>
        <div id="visionHubdiv">
        ...
        <div id="sloganVH">
            ...
            <p id="subSloganVH">Select the tool that best suits the idea you want to realize</p>
        </div>
        <div id="mainBodyTemplate">
            <div id="wrapperCommunity" class="genericWrapper">
                <div id="communityGrid">
                    <div id="comunnityDiv1" class="subVisionHubdiv comunnityDiv hidden">
                    ...
                    <div id="comunnityDiv2" class="subVisionHubdiv comunnityDiv hidden">
                        <div class="flipCardDetails">
            ...
            <div id="wrapper2D" class="genericWrapper">
                <div id="generatordiv2d" class="subVisionHubdiv hidden">
                    ...
                    <div id="content1">
                        ...
                        <a href=""><div id="generatorB2d" class="buttonApp">
                            Let's Generate!
                        </div></a>
                    </div>
                    <div class="flipCardDetails">
            ...
            <div id="wrapper3D" class="genericWrapper">
                <div id="generatordiv3d" class="subVisionHubdiv hidden">
                    ...
                    <div id="content1">
                        ...
                        <a href=""><div id="generatorB3ds" class="buttonApp">
                            Let's Generate!
                        </div></a>
                    </div>
                    <div class="flipCardDetails">
            ...
            <div id="footerWrapper">
                <div id="gridFooter">
                    ...
                    <div class="gridFooterElement" id="contacts">
                        <p><em>This is a Open Source Project <br>
                            Feel free you propagate your ideas!
                        </em></p>
                    </div>
                    <div class="gridFooterElement" id="socialMedias">
                        <a href="https://github.com/r0zh/VisionHub"><div id="gitHubLink">
                            <img src="/images/icons8-github.svg" alt="">
                            VisionHub
                        </div></a>
                        <a href="mailto:inbox.visionhub@gmail.com?subject=New Suggestion to VisionHub"><div id="gitHubLink">
                            <img src="/images/icons8-correo-96.png" alt="">
                            Suggestions
                        </div></a>
                    </div>
